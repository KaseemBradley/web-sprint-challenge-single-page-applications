...
This hook is used for having access to a match object which can dsiplay how a route path mathces the URL

1. How would you explain form validation to someone who has never programmed before?

Form validation is a way of checking that all required inputs are filled in correctly before submitting the form.

1. In 1-2 sentences, define end to end testing.

This is an intensive test that ensures the app runs as expected for a user from start to finish.
